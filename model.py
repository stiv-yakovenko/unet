...
def unet(pretrained_weights = None,input_size = (256,256,3)):
    ...
    model.compile(optimizer = SGD(lr=.3e-4,decay=1e-6, momentum=0.9, nesterov=True), loss = dice_coef_loss, metrics = ['binary_crossentropy','accuracy',mean_iou,dice_coef_loss])
    # model.summary()
